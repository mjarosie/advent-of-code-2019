[--- Day 3: Crossed Wires: Part Two ---](https://adventofcode.com/2019/day/3)
...
only 8+5+2 = 15 and the second wire takes only 7+6+2 = 15, a total of 15+15 = 30 steps.
...
```bash
stack exec find-closest-intersection <path to input file>
```
