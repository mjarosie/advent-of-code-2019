[--- Day 2: 1202 Program Alarm: Part Two ---](https://adventofcode.com/2019/day/2)
...
To get a result (in my case the desired value was `19690720`):

```bash
stack exec run-intcode-program <path to input file> <desired Intcode computer output value>
```
